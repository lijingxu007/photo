...
function methods () {
  ...
  self.updateCanvas = function () {
    ...
    self.ctx.setTextAlign('center')
    self.ctx.setFillStyle('#fff')
    self.ctx.fillText(String(app.text.zh||''), device.windowWidth / 2, device.windowWidth*0.38)
    self.ctx.fillText(String(app.text.en||''), device.windowWidth / 2, device.windowWidth * 0.41)
    self.ctx.draw();
    return self
  };
